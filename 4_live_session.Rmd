...
- obviously they are used commercially to produce honey
- they're also important in pollination services to other agricultural sectors
- despite their commercial importance they haven't really been through an extensive selection process like other livestock such as sheep and cattle
- there are now genetic improvement programs in place in australia and new zealand to address this
- these programs combine genome-wide genotyping of honeybees with measurements of hive performance to find markers that could be associated with performance
- this is livestock improvement process called genomic selection
- plus, they are cute so why wouldn't you want to work on them
- they are also pretty interesting from an evolutionary point of view because of their unusual social structure and sex determination system
:::
...
::: notes
\tiny
- the first honeybee genome was released in 2006
- it's called the Amel\_4.0 assembly for apis mellifera
- that's an internal name from the lab doing the assembly, it doesn't mean it was the fourth genome released
- this was a shotgun plus sanger sequencing approach
- like the one i described for the first human genome assembly in the lecture material
- they managed to assemble scaffolds for all of the 16 honeybee chromosomes, but there were lots of gaps caused by issues with coverage of certain regions, and the number of genes was quite low
:::
...
::: notes
\tiny
- it was quite a surprise to find such a low number of genes
...
- far from it - the initial assemblies were a lot of work and very useful as reference genomes
...
::: notes
\tiny
- i've taken the three honeybee genomes and compared them with the metrics i talked about in video three
...
- these are the two individuals from the genomic improvement program i mentioned
- these honeybees have personalised genomes and they didn't even have to pay a biotech company for it
...
- these are whole-genome alignments against the hybrid assembly to see if the local genome assemblies are ok, and they're reasonable - scaffold N50 around 8 Mb
...
::: notes
\tiny
- and this is a closer look at the alignment of these two genomes against one of the reference chromosomes
- both of these individuals have a 2.5 Mb inversion on this chromosome
- so these honeybees are the same species as US honeybees
- is the genome the same?
- no. ordinary reference genomes are just a snapshot of the genomes in the individuals that were sequenced
- variants are out there and they need to be incorporated into the reference
:::
