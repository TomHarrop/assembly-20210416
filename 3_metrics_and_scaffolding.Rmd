...
- this brings me to the various words that are used to describe the quality of assemblies
- most of these descriptions are used pretty loosely so these aren't formal definitions at all
...
- and then as i just said, a telomere to telomere or complete assembly contains the whole sequence of the chromosome, with the word closed meaning that the gaps have been filled in
...
- don't worry about it too much, you will have plenty of chances to get used to N50 statistics
- for now if it's not making sense, you can just remember that it's a statistic for describing the distribution of fragment sizes, just like the mean contig length is
